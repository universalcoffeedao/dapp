...
// import { bscTestNetBusd } from "../../../helpers/tokens";
import { shorten, trim } from "../../../helpers";
import BondLogo from "../../../components/BondLogo";
import { useDispatch, useSelector } from "react-redux";
import { IReduxState } from "../../../store/slices/state.interface";
import { calcZapinDetails, ITokenZapinResponse } from "../../../store/slices/zapin-thunk";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    // let defaultToken = tokens.find(token => token.name === bscTestNetBusd.name);
    let defaultToken = "";
                    ...
                    <div className="zapin-header">
                        <div className="zapin-header-token-select-wrap">
                            ...
                            {hasAllowance() || token.isAvax ? (
                                ...
                                >
                                    <p>{txnButtonText(pendingTransactions, "zapin_" + token.name + "_" + bond.name, "Bond")}</p>
                                </div>
                            ) : (
                                <div
                                    className="zapin-header-token-select-btn"
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} CALM`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} CALM`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 CALM</p>
                            </div>
                        </div>
                    </div>
