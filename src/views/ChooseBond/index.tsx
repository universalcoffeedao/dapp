      ...
      <Zoom in={true}>
        <div className="choose-bond-view-card">
          <div className="choose-bond-view-card-header">
            <p className="choose-bond-view-card-title"> Mint CALM (☮️, ☮️)</p>
          </div>
          ...
          <Grid container item xs={12} spacing={2} className="choose-bond-view-card-metrics">
            ...
            <Grid item xs={12} sm={6}>
              <Box textAlign="center">
                <p className="choose-bond-view-card-metrics-title">CALM Market Price</p>
                  ...
                  <TableHead>
                    <TableRow>
                      <TableCell align="center">
                        <p className="choose-bond-view-card-table-title">Token</p>
                      </TableCell>
                      <TableCell align="center">
                        <p className="choose-bond-view-card-table-title">Minting Price</p>
                      </TableCell>
                      <TableCell align="center">
